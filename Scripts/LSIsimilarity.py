...
class LSIsimilarity:
    ...
    def train(self,basepath='/home/kdane/Desktop/Computationaltools/WikipediaCategorization-master/WikipediaCategorization-master/Baseline/plaindata1'):
        ...
        #    self.corpus = corpora.MmCorpus("corpus.mm1")
        #    self.index = similarities.MatrixSimilarity.load('myindex.index')
        ...
        #self.dictionary.save("dictionary1.dict")
        self.corpus = [self.dictionary.doc2bow(text) for text in self.articles]
        #corpora.MmCorpus.serialize("corpus.mm1", self.corpus)
    ...
    def compare(self, quary):
        ...
        self.query_path=self.dictionary.doc2bow(quary.lower().split())
        print()
